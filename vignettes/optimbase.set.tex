\inputencoding{utf8}
\HeaderA{optimbase.set}{Optimization Object Configuration}{optimbase.set}
\aliasA{optimbase.histset}{optimbase.set}{optimbase.histset}
\keyword{method}{optimbase.set}
%
...
%
\begin{Details}\relax
\code{optimbase.set} set the content of the \code{key} element of the 
optimization object \code{this} to \code{value}.

The only available keys in \code{optimbase.set} are the following:
\begin{description}
